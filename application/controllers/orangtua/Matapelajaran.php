...
class matapelajaran extends CI_Controller{
  ...
  public function index(){
    ...
    $this->load->view('orangtua/matapelajaran',$data);
  ...
  public function tambah_matapelajaran(){
    ...
    $this->load->view('templates_orangtua/header');
    $this->load->view('templates_orangtua/sidebar');
    $this->load->view('orangtua/matapelajaran_form',$data);
    $this->load->view('templates_orangtua/footer');
  }
  ...
  public function tambah_matapelajaran_aksi(){
    ...
    if($this->form_validation->run() == FALSE){
      ...
      redirect('orangtua/matapelajaran');
    }
  }
  ...
  public function detail($id){
    ...
    $this->load->view('templates_orangtua/header');
    $this->load->view('templates_orangtua/sidebar');
    $this->load->view('orangtua/matapelajaran_detail',$data);
    $this->load->view('templates_orangtua/footer');
  }
  ...
  public function update($id){
    ...
    $this->load->view('templates_orangtua/header');
    $this->load->view('templates_orangtua/sidebar');
    $this->load->view('orangtua/matapelajaran_update',$data);
    $this->load->view('templates_orangtua/footer');
  }
