...
class pengajar extends CI_Controller{
  ...
  public function index(){
    ...
    $this->load->view('orangtua/pengajar', $data);
  ...
  public function detail($id){
    ...
    $this->load->view('templates_orangtua/header');
    $this->load->view('templates_orangtua/sidebar');
    $this->load->view('orangtua/pengajar_detail', $data);
    $this->load->view('templates_orangtua/footer');
  }
  ...
  public function tambah_pengajar(){
    $this->load->view('templates_orangtua/header');
    $this->load->view('templates_orangtua/sidebar');
    $this->load->view('orangtua/pengajar_form');
    $this->load->view('templates_orangtua/footer');
  }
  ...
  public function update($id){
    ...
    $this->load->view('templates_orangtua/header');
    $this->load->view('templates_orangtua/sidebar');
    $this->load->view('orangtua/pengajar_update', $data);
    $this->load->view('templates_orangtua/footer');
  }
