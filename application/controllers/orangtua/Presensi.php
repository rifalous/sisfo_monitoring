...
class Presensi extends CI_Controller{
  ...
  public function index(){
    ...
    $this->load->view('orangtua/presensi', $data);
  ...
  public function print(){
    ...
    $data['presensi'] = $this->db->query(
        "SELECT siswa.nama_lengkap, siswa.kelas, presensi.* from siswa left join presensi ON siswa.id = presensi.id_siswa WHERE presensi.bulan = '$bulan' ORDER BY siswa.nama_lengkap ASC")
    ->result();
    $this->load->view('orangtua/print_laporan_presensi', $data);
  }
  ...
  public function tambah_presensi(){
    ...
    $this->load->view('templates_orangtua/header');
    $this->load->view('templates_orangtua/sidebar');
    $this->load->view('orangtua/presensi_form');
    $this->load->view('templates_orangtua/footer');
  }
  ...
  public function update($id){
    ...
    $this->load->view('templates_orangtua/header');
    $this->load->view('templates_orangtua/sidebar');
    $this->load->view('orangtua/presensi_update',$data);
    $this->load->view('templates_orangtua/footer');
  }
