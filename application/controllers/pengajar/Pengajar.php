...
class pengajar extends CI_Controller{
  ...
  public function index(){
    ...
    $this->load->view('pengajar/pengajar', $data);
  ...
  public function detail($id){
    ...
    $this->load->view('templates_pengajar/header');
    $this->load->view('templates_pengajar/sidebar');
    $this->load->view('pengajar/pengajar_detail', $data);
    $this->load->view('templates_pengajar/footer');
  }
  ...
  public function tambah_pengajar(){
    $this->load->view('templates_pengajar/header');
    $this->load->view('templates_pengajar/sidebar');
    $this->load->view('pengajar/pengajar_form');
    $this->load->view('templates_pengajar/footer');
  }
  ...
  public function update($id){
    ...
    $this->load->view('templates_pengajar/header');
    $this->load->view('templates_pengajar/sidebar');
    $this->load->view('pengajar/pengajar_update', $data);
    $this->load->view('templates_pengajar/footer');
  }
