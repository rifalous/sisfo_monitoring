...
class matapelajaran extends CI_Controller{
  ...
  public function index(){
    ...
    $this->load->view('pengajar/matapelajaran',$data);
  ...
  public function tambah_matapelajaran(){
    ...
    $this->load->view('templates_pengajar/header');
    $this->load->view('templates_pengajar/sidebar');
    $this->load->view('pengajar/matapelajaran_form',$data);
    $this->load->view('templates_pengajar/footer');
  }
  ...
  public function tambah_matapelajaran_aksi(){
    ...
    if($this->form_validation->run() == FALSE){
      ...
      redirect('pengajar/matapelajaran');
    }
  }
  ...
  public function detail($id){
    ...
    $this->load->view('templates_pengajar/header');
    $this->load->view('templates_pengajar/sidebar');
    $this->load->view('pengajar/matapelajaran_detail',$data);
    $this->load->view('templates_pengajar/footer');
  }
  ...
  public function update($id){
    ...
    $this->load->view('templates_pengajar/header');
    $this->load->view('templates_pengajar/sidebar');
    $this->load->view('pengajar/matapelajaran_update',$data);
    $this->load->view('templates_pengajar/footer');
  }
